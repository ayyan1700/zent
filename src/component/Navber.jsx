    ...
    return (
        <nav
            className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ease-in-out
                 ${scrolled
                    ? 'py-1 bg-black/20 backdrop-blur-xl border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)]'
                    : 'py-2 bg-transparent border-b border-white/[0.05]'
                }`}
        >
            <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-10 flex justify-between items-center">
                ...
                <Link to="home" smooth={true} className="z-[110] cursor-pointer">
                    <img
                        src={logo}
                        alt="Logo"
                        className="h-25 w-auto object-contain transition-opacity hover:opacity-80"
                    />
                </Link>
