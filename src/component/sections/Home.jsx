...
// CEO Image import
import profileImg from '../../assets/ceos.png';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-5 flex justify-center relative">
                        <div ref={imageRef} className="relative group">
                            ...
                            {/* 3. Image Container (ISKO CHANGE KIYA HAI) */}
                            <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-white/10 relative z-10">
                                <img
                                    src={profileImg}
                                    alt="Zentiboo CEO"
                            ...
                            <motion.div
                                ...
                                transition={{ delay: 1 }}
                                className="absolute bottom-4 -right-4 bg-white/5 backdrop-blur-xl border border-white/10 p-4 rounded-3xl shadow-2xl z-20"
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center text-white font-black italic text-xs">Z</div>
                                    <div>
                                        <h4 className="text-white font-black text-[10px] leading-none uppercase tracking-tighter">CEO Vision</h4>
                                        <p className="text-[8px] text-indigo-400 font-bold uppercase mt-1">Founder 2026</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
